              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => LoginNegocioPage(),));
                        // Navigator.push(context, MaterialPageRoute(builder: (context) => Test1Page()));
                      },
                      child: Text(
                        "Soy Negocio",
                        style: TextStyle(fontSize: 20.0, color: kBrandSecundaryColor1),
                      ),
                    ),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => LoginClientePage(),));
                      },
                      child: Text(
                        "Soy Cliente",
